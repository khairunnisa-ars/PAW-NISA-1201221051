    ...
    <div class="row justify-content-center mt-5 mt-lg-7">
        <div class="col-xl-10">
            <div class="bg-white rounded-4 shadow p-5 d-flex flex-column flex-lg-row align-items-center">
                <!-- Icon -->
                <div class="bg-light rounded-circle d-flex align-items-center justify-content-center me-lg-5 mb-4 mb-lg-0 shadow" style="width: 200px; height: 200px; overflow: hidden;">
                    <!-- ==================4================== -->
                    <!-- Tampilkan logo profil -->
                    <!-- Menggunakan asset() untuk mendapatkan path ke public/images/logo_ead.png (sesuaikan nama file jika berbeda) -->
                ...
                <div class="text-center text-lg-start">
                    ...
                    <!-- Menampilkan variabel $salam dan $nama -->
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-center justify-content-lg-start gap-4 fs-5 text-muted">
                        <div class="d-flex align-items-center">
                            ...
                            <!-- ==================6================== -->
                            <!-- Tampilkan Waktu -->
                            <!-- Menampilkan variabel $waktuAkses -->
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!-- ==================7================== -->
                            <!-- Tampilkan Tanggal -->
                            <!-- Menampilkan variabel $tanggalAkses -->
